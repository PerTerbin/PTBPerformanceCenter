...
#if _INTERNAL_MLF_RC_ENABLED
    __block NSArray *retainCycleArray = @[@"Fail to find a retain cycle"];
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
//        FBRetainCycleDetector *detector = [FBRetainCycleDetector new];
//        [detector addCandidate:proxy.object];
...
//                    retainCycleArray = [proxy shiftArray:retainCycle toIndex:index];
//                    hasFound = YES;
//                    break;
//                }
//                ++index;
...
//        }
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [[PTBPerformanceCenter defaultCenter].viewController findMenoryLeakWithViewStack:proxy.viewStack retainCycle:retainCycleArray];
        });
    });
#else
